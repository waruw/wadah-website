            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <br>
                        <div class="mt-4">
                            <a href="https://give2asia.org/wadahfoundation/" target="_blank"><img
                                    src="{{ asset('img/give2asia.png') }}" widht="auto" height="40";> </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <div class="social-links mt-3">
                            <a href="https://twitter.com/wadahfoundation" target="_blank" class="twitter"><i
                                    class="bx bxl-twitter"></i></a>
                            <a href="https://www.facebook.com/wadahfoundation" target="_blank" class="facebook"><i
                                    class="bx bxl-facebook"></i></a>
                            <a href="https://www.instagram.com/wadahfoundation/" target="_blank" class="instagram"><i
                                    class="bx bxl-instagram"></i></a>
                            <a href="https://www.youtube.com/user/wadahfoundation" target="_blank" class="Youtube"><i
                                    class="bx bxl-youtube"></i></a>
                            <a href="https://www.linkedin.com/company/wadahfoundation" target="_blank"

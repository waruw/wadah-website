        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="col-mb-12 mb-4">
                    <div class="position-relative">
                        <div>
                        <a href="{{route('news.show', $news->slug)}}"> <img class="img-fluid w-100" src="{{asset($news->image)}}" 
                            ...
                            <div class="d-flex mb-3">
                                <div class="position-relative mb-6 border-end-0">
                                    ...
                                    <div class="overlay position-relative ">
                                        ...
                                        <div class="pnewspost">
                                            <p style="text-align:justify";>{!!\Illuminate\Support\Str::limit($news->article, 100, '...')!!} 
                                            {{-- <a href='{{route('news.show', $news->slug)}}' class="float-end btn btn-sm btn-outline-dark">Read More</a></p> --}}
                                        </div>
                                    </div>
                                </div>
                ...
                @elseif (App::currentLocale()=="id")
                <h6 class="right mt-4"> <a href="{{ url('/news')}}">LAINNYA >></a></h6>
                @endif
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-12 d-flex mb-3">
                        <a class="sizepicside" href="{{route('news.show', $news->slug)}}"> <img src="{{asset($news->image)}}" 

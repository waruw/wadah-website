...
<section class="inner-page">
        <div class="container">
            ...
            <div>
              <p  style="text-align:justify; color:green;"> <img style="float:left; margin-right: 25px; margin-bot: 35px" 
                  src="{{asset('img/media/publication/satudasawarsawadah.jpg')}}" widht="336" height="252";>
                  <b>SATU DASAWARSA WADAH MENGABDI <br>
                  A Decade of Service to Humanity 2008 - 2018 </b></p>
            ...
            <div>
              <p  style="text-align:justify; color:green;"> <img style="float:left; margin-right: 25px; margin-bot: 30px" 
                  src="{{asset('img/media/publication/ibu.jpg')}}" widht="336" height="252";>
                    <b> IBU - A Pillar of Life <br>
                    Wadah Women in Their Community </b></p>
            ...
            <div>
              <p  style="text-align:justify; color:green;"> <img style="float:left; margin-right: 25px; margin-bot: 30px" 
                  src="{{asset('img/media/publication/obor.jpg')}}" widht="336" height="252";>
                    <b> Obor <br>
                    Torchbearers of Hope </b> </p>
            ...
            <div>
              <p  style="text-align:justify; color:green;"> <img style="float:left; margin-right: 25px; margin-bot: 30px" 
                  src="{{asset('img/media/publication/trotoar.jpg')}}" widht="336" height="252";>
                    <b>TROTOAR <br>
                    THE LOST CHILDREN OF INDONESIA </b> </p>
